...
var author$project$Main$Model = function (time) {
	return {time: time};
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A4(mdgriffith$elm_ui$Element$rgba, 255, 255, 255, 1))
			]),
		A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							mdgriffith$elm_ui$Element$text(
							elm$core$String$fromInt(model.time))
						]))
				])));
};
